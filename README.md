...
For details, please check the IEDC handbook.
...
•	Implement a few additions to floweaver Sankeys, including the automatic display of a caption, a color legend, a reference flow to show the scale of the values shown, a license statement, and a traceability statement.
